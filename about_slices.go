...
func aboutSlices() {
	...
	pregnancy_slots = append(pregnancy_slots, "another baby!?", "yet another, oh dear!", "they must be Catholic")
  assert(cap(pregnancy_slots) == 12)  // there are only 10 elements taken; pregnancy_slots can stay with 12 elements of capacity

	pregnancy_slots = append(pregnancy_slots, "another baby!?", "yet another, oh dear!", "they must be Catholic")
  assert(cap(pregnancy_slots) == 24)  // there are 13 elements taken; pregnancy_slots duplicates its capacity
